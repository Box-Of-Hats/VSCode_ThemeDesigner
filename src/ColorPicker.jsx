    ...
    render() {
        ...
        return (
            <div className="colorPickerComponent">
                ...
                <button style={{ boxShadow: this.props.selected ? `inset 10px 1px 0px ${this.props.color}` : "none", border: `2px solid ${this.props.color}` }} className={`colorPickerComponent__button ${highlightClass}`} role="button" onClick={this.handleSelectButtonClick}>select</button>
            </div>
        );
    }
}
